...
<div class="wrapper">
<link rel="icon" type="image/png" href="{{secure_asset('adminlte/logo.jpg')}}">
  <!-- Preloader -->
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{secure_asset('adminlte/logo.jpg')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
