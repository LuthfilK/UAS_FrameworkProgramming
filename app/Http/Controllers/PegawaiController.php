...
{   
    ...
    public function index()
    {
        ...
        $hasil = DB::table('pegawai2')->distinct('id')->count('id');
    ...
    public function list()
    {
        ...
        $hasil = DB::table('pegawai2')->paginate(10);
        return view('data-pegawai', ['data' => $hasil]);
    }
    ...
    public function simpan(Request $req)
    {
        ...
        DB::insert(
            'insert into pegawai2 (nip,nama, alamat, file) values (?, ?, ?, ?)',
    ...
    public function hapus($req)
    {
        ...
        DB::delete('delete from pegawai2 where id = ?', [$req]);
    ...
    {
        $hasil = DB::select('select * from pegawai2 where id = ?', [$req]);
